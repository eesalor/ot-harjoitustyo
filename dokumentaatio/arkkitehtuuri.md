...
Sovelluksen tehtävänäkymä päivittyy metodin `_update_task_view` avulla, joka edelleen kutsuu metodia `_show_task_list`. Tämän seurauksena näkymä luodaan uudelleen luokan `TaskView` avulla, jolloin ikkuna päivittyy. Näin tapahtuu esimerkiksi silloin, kun käyttäjä lisää tehtävän, merkitsee tehtävän tehdyksi / tekemättömäksi tai poistaa tehtävän tai kategorian.
